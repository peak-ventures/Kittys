...
const FacebookForm = ({ toggleModal }) => (
    ...
    >
        {({ values, handleChange, handleSubmit, errors, touched }) => (
            <>
                <input type="email" value={values.email} onChange={handleChange('email')} placeholder="Input Electronic Mail Address"/>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col">
                            ...
                            <p className="mt-5">Does it feel like your agency isn’t invested in you? Kittys strives to be an extension of your team. We
