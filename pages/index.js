...
import { getAdAccounts } from '../network';
...
export default () => {
    ...
    const FacebookAuthButton = ({ onClick }) => {
        const facebookResponse = async response => {
            toggleModal(false);

            // Store in state
            setToken('random-response-token-123456789');
            setName('Bob Marley');
            setUserId(123456789);

            // Use email + token to get ad accounts
            const adAccounts = await getAdAccounts(email, token);
            // setAdAccount(adAccounts) // Example
            setAdAccount([
                { id: 1, name: 'Kittys Example 1' },
                { id: 1, name: 'Kittys Example 2' },
                { id: 1, name: 'Kittys Example 3' },
            ]);
        ...
        return (
            <FacebookLogin
                ...
                render={<button onClick={onClick}>Authorize Account Check</button>}
            />
        )
    };
    ...
    return (
        ...
        `}</style>
            ...
            <section className="qualify">
                <h2>How to Qualify<img src="static/imgs/qualify.png" className="quality-img"/></h2>
                ...
                <ul>
                    <li>
                        <img src="static/imgs/qualify-item.png" alt="qualifying item"/>
                        <div>Spent over 1 Million Dollars on Facebook in 2018
                            <div className="repeat-underline"></div>
                        </div>
                    </li>
                    <li>
                        <img src="static/imgs/qualify-item.png" alt="qualifying item"/>
                ...
                <p style={{ marginTop: '52px' }}>To get started, connect with our automatic account analysis tool and we will
                    contact you if you qualify.</p>
            </section>

            <section className="cta dark">
                <FacebookForm error={false} />
            </section>
            ...
            <section className="sponsors">
                <svg viewBox="0 0 339 118">
                    ...
                    <g fill="none" transform="translate(0 -1)">
                        ...
                        <path fill="#262626"
                              d="M224.985 82.947c-.146-.013-3.238-.244-3.238-.244l-2.383-2.393a.589.589 0 0 0-.331-.155l-1.735 35.862 12.43-2.718s-4.364-29.818-4.392-30.023a.39.39 0 0 0-.35-.33"/>
                        <path fill="#FFF"
                              d="M213.077 89.889l-1.532 4.608s-1.344-.725-2.99-.725c-2.413 0-2.535 1.531-2.535 1.917 0 2.104 5.429 2.91 5.429 7.84 0 3.879-2.434 6.377-5.716 6.377-3.939 0-5.952-2.478-5.952-2.478l1.054-3.521s2.07 1.796 3.818 1.796c1.14 0 1.605-.908 1.605-1.571 0-2.746-4.453-2.869-4.453-7.38 0-3.796 2.695-7.471 8.139-7.471 2.097 0 3.133.608 3.133.608"/>
                        <path fill="#333"
            ...
            <section className="results">
                <svg viewBox="0 0 414 53">
                    <path fill="#F9F9F9" d="M0 0h414v33c-113.625-4.806-199.483-5.806-257.573-3C98.337 32.806 46.195 40.473 0 53V0z"/>
                </svg>
            ...
            <section className="craft">
                ...
                <ul>
                    ...
                    <li>
                        <img src="static/imgs/craft-item.png" alt="craft item"/>
                        <div>Over 1 billion impressions in 2018
                            <div className="repeat-underline"/>
                        </div>
                    </li>
                    <li>
                        <img src="static/imgs/craft-item.png" alt="craft item"/>
                        <div>Advertised on Facebook for at least 6 months<div className="repeat-underline" /></div>
                    </li>
                </ul>
            ...
            <section className="getStarted dark">
                <h2>Get Started<img src="static/imgs/crafted.png" className="getstarted-img"/></h2>
            ...
            <section className="cta light" style={{ paddingBottom: '115px' }}>
                <FacebookForm value={email} onChange={e => setEmail(e.target.value)} error={false} />
            </section>
